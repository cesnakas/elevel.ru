...
else
{
	...
	$arValues = array (
		"form_text_1638"		=> utf8win1251(htmlspecialchars($_POST["form_text_1638"])), // Имя
		"form_text_1639"        => htmlspecialchars($_POST["form_text_1639"]), // Телефон
		"form_email_1640"       => htmlspecialchars($_POST["form_email_1640"]),	// Email
		"form_textarea_1641"        => utf8win1251(htmlspecialchars($_POST["form_textarea_1641"])),	// Сообщение
	);
