...
<?if(!isset($_COOKIE['town'])):?>
		...
		<a href="#"><span><?=$defTowns[$default_town]['T']?></span><i class="tz-caret"></i></a>
		<div class="tz-phone"><span><?=$defTowns[$default_town]['CT']?></span> <?=$defTowns[$default_town]['PH']?>
			<a href="<?=SITE_DIR?>contacts/" class="all-contacts">Все контакты </a>
		</div>
		
		<div class="list171" prices='<?=$arTowns[$default_town]['PRICES']?>'>
			<a href="#"><span><?=$arTowns[$default_town]['T']?></span><i class="tz-caret"></i></a>
			<ul>
				<?foreach($arTowns as $ctown=>$town):?>
					<li phone="<?=$town['PH']?>" code_ph="<?=$town['CT']?> " tcode="<?=$ctown;?>" prices="<?=$town['PRICES']?>"><span><?=$town['T']?></span></li>
				<?endforeach?>
	...
	<?else:?>
		<a href="#"><span><?=$arTowns[$_COOKIE['town']]['T']?></span><i class="tz-caret"></i></a>
		
		<div class="tz-phone"><span><?=$arTowns[$_COOKIE['town']]['CT']?></span> <?=$arTowns[$_COOKIE['town']]['PH']?>
			<a href="<?=SITE_DIR?>contacts/" class="all-contacts">Все контакты </a>
		</div>
