...
<div class="top-service-block shinoprovod clearfix">
	...
	<div class="right-block">
		<h3 class="headline calculator">Рассчитать стоимость шинопровода</h3>
...
<?$APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "sp_msk@elevel.ru",	"FORM_TITLE" => "Форма обратной связи с руководителем",	"PAGE_TITLE" => "Шинопровод"), $component);?>
