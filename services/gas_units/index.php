...
$APPLICATION->SetTitle("Газопоршневые установки");?>
<div class="heading-partners clearfix">
	<h1 class="headline gas">Газопоршневые установки</h1>
...
<div class="top-service-block clearfix">
	...
	<div class="right-block">
		<fieldset>
			<h3>Не знаете с чего начать? Пришлите пожалуйста технические условия и описание своей задачи. Ответим быстро и по делу!</h3>
	...
	Array(
		...
		"EDIT_URL" => "",
		"FORM_TITLE" => "Узнать стоимость ГПУ",
		"IGNORE_CUSTOM_TEMPLATE" => "N",
		"LIST_URL" => "",
		"MANAGER_EMAIL" => "gpu_msk@elevel.ru",
		"PAGE_TITLE" => "",
		"PAGE_URL" => "",
		"SEF_MODE" => "N",
		"SUCCESS_URL" => "",
...
<?$APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "gpu_msk@elevel.ru",	"FORM_TITLE" => "Форма обратной связи с руководителем",	"PAGE_TITLE" => ""), $component);?>
...
<h2>Производители газопоршневых установок</h2>
 <?$APPLICATION->IncludeComponent(
...
$filterProjects = array(
  "PROPERTY_OBJECT_TYPE_VALUE" => "Производственные, складские"
);
?>
