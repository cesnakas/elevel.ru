...
$APPLICATION->SetTitle("Главные распределительные щиты ГРЩ");
$APPLICATION->SetPageProperty("title", "Главные распределительные щиты ГРЩ");
?> 
...
<section class="section-special-offer">
	...
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"PAGE_TITLE" => "Главные распределительные щиты ГРЩ",
			"PAGE_URL" => "",
			"VARIABLE_ALIASES" => array(
				"WEB_FORM_ID" => "WEB_FORM_ID",
				"RESULT_ID" => "RESULT_ID",
