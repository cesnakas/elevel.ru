...
<? $APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "nku_msk@elevel.ru", "FORM_TITLE" => "Форма обратной связи с руководителем", "PAGE_TITLE" => ""), $component); ?>
    ...
    <section class="section-inside section-content">
        ...
        <div class="slider-single list-inside">
            <div>
                <div class="slide-inner">
                    <a href="#3d-tour" class="visual street-view lightbox-open">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/images/3d.jpg" alt=""/>
                    </a>
                    <strong>3D-тур по цеху напольных конструкций НКУ</strong>
            ...
            <div>
                <div class="slide-inner">
                    <a href="#3d-tour-2" class="visual street-view lightbox-open">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/images/3d-2.jpg" alt=""/>
                    </a>
                    <strong>3D-тур по цеху навесных электрощитов</strong>

                    <div class="lightbox-holder">
                        <div id="3d-tour-2" class="lightbox">
                            <? $APPLICATION->IncludeFile($APPLICATION->GetCurDir() . "include/3d-tour-2.php", Array(), Array("MODE" => "html")); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="slide-inner">
                    <? $APPLICATION->IncludeComponent(
                        ...
                        array(
                            ...
                            "POPUP_TITLE" => "Внимание! Сервис доступен только заказчикам. Для получения доступа заполните форму",
                            "PAGE_URL" => "",
                            "PAGE_TITLE" => "",
                            "BUTTON_TITLE" => "",
                            "VARIABLE_ALIASES" => array(
...
<?/*
    <section class="section-brands section-content">
        ...
        <? $APPLICATION->IncludeComponent("magnitmedia:assortiment", ".default", array(
	"CACHE_TIME" => "86400",
		"IBLOCK_ID" => "124",
