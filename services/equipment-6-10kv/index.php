...
$APPLICATION->SetTitle("Оборудование 6-35 кВ"); ?>
    <div class="heading-partners clearfix">
        <h1 class="headline electrical-board">Оборудование 6-35 кВ</h1>
    ...
    <div class="top-service-block oem clearfix">
        ...
        <div class="right-block">
            <h3>Узнать стоимость трансформаторной подстанции (ТП)</h3>
            <? $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "WEB_FORM_ID" => "113",
                    "COMPONENT_TEMPLATE" => "form7",
                    "MANAGER_EMAIL" => "6kv_msk@elevel.ru",
                    "FORM_TITLE" => "Узнать стоимость трансформаторной подстанции (ТП)",
                    "PAGE_TITLE" => "Оборудование 6-35 кВ",
...
<? $APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "6kv_msk@elevel.ru", "FORM_TITLE" => "Форма обратной связи с руководителем", "PAGE_TITLE" => ""), $component); ?>
    ...
    <section class="section-examples section-content">
        <h2>Примеры работ</h2>
        <? $APPLICATION->IncludeFile($APPLICATION->GetCurDir() . "include/work_examples.php", Array(), Array("MODE" => "html")); ?>
    </section>

    <section class="section-brands section-content">
        <h2>Ассортиментное оборудование для трансформаторных подстанций</h2>
...
$filterProjects = array(
    "PROPERTY_SOLUTION_TYPE_VALUE" => "оборудование 6-35кВ"
);
?>
...
<? $APPLICATION->IncludeFile($APPLICATION->GetCurDir() . "include/other_services.php", Array(), Array("MODE" => "html")); ?>
    ...
    <section class="section-special-offer">
        <h2>Запросить специальные условия на оборудование для ТП</h2>
        <? $APPLICATION->IncludeComponent(
            "magnitmedia:form.result.new",
            "form2",
            array(
                ...
                "MANAGER_EMAIL" => "6kv_msk@elevel.ru",
                "FORM_TITLE" => "Запросить специальные условия на оборудование для ТП",
                "PAGE_URL" => "",
                "PAGE_TITLE" => "",
                "VARIABLE_ALIASES" => array(
                    "WEB_FORM_ID" => "WEB_FORM_ID",
