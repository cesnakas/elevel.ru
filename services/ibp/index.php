...
$APPLICATION->SetTitle("Источники бесперебойного питания (ИБП)"); ?>
    <div class="heading-partners clearfix">
        <h1 class="headline ibp">Источники бесперебойного питания (ИБП)</h1>
    ...
    <div class="top-service-block oem clearfix">
        ...
        <div class="right-block">
            <section class="choose-ibp">
                <h3>Какой ИБП подходит под вашу задачу?</h3>
                <p>
                    Бесплатный расчёт требуемой мощности и времени автономной работы ИБП (UPS)
                </p>
                <? $APPLICATION->IncludeComponent(
                    "magnitmedia:form.result.new",
                    "manager_feedback_form",
                    array(
                        "BUTTON_TITLE" => "Подобрать ИБП",
                        ...
                        "EDIT_URL" => "",
                        "FORM_TITLE" => "Бесплатный расчёт требуемой мощности и времени автономной работы ИБП (UPS)",
            ...
            <section>
                <h3 class="headline calculator">Узнать стоимость ИБП</h3>
                <? $APPLICATION->IncludeComponent(
                    "magnitmedia:form.result.new",
                    "form6",
                    array(
                        ...
                        "CHAIN_ITEM_LINK" => "",
                        "CHAIN_ITEM_TEXT" => "",
                        "COMPONENT_TEMPLATE" => "form6",
                        "EDIT_URL" => "",
                        "FORM_TITLE" => "Калькулятор расчета стоимости ИБП",
                        "IGNORE_CUSTOM_TEMPLATE" => "N",
                        "LIST_URL" => "",
                        "MANAGER_EMAIL" => "ibp_msk@elevel.ru",
                        "PAGE_TITLE" => "Источники бесперебойного питания (ИБП)",
                        "PAGE_URL" => "",
                        "SEF_MODE" => "N",
                        "SUCCESS_URL" => "",
                        "USE_EXTENDED_ERRORS" => "N",
...
<? $APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "ibp_msk@elevel.ru", "FORM_TITLE" => "Форма обратной связи с руководителем", "PAGE_TITLE" => ""), $component); ?>
    ...
    <section class="section-brands section-content">
        <h2>Ассортиментное предложение по ИБП</h2>
        <? $APPLICATION->IncludeComponent(
...
$filterProjects = array(
    "PROPERTY_SOLUTION_TYPE_VALUE" => "источники бесперебойного питания"
);
?>
...
<? $APPLICATION->IncludeFile($APPLICATION->GetCurDir() . "include/other_services.php", Array(), Array("MODE" => "html")); ?>
    <section class="section-special-offer">
        <h2>Получить специальные условия на ИБП</h2>
        <? $APPLICATION->IncludeComponent(
            "magnitmedia:form.result.new",
            "form2",
            array(
                ...
                "EDIT_URL" => "",
                "FORM_TITLE" => "Получить специальные условия на ИБП",
                "IGNORE_CUSTOM_TEMPLATE" => "N",
                "LIST_URL" => "",
                "MANAGER_EMAIL" => "ibp_msk@elevel.ru",
                "PAGE_URL" => "",
