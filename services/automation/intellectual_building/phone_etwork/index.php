...
$APPLICATION->SetPageProperty("tags", "телефонная сеть здания, проектирование телефонной сети, ip телефония");
$APPLICATION->SetPageProperty("keywords", "телефонная сеть здания, проектирование телефонной сети, ip телефония");
$APPLICATION->SetTitle("Телефонные сети ");
?>
<h1>Телефонные сети</h1>
 
<p>Система телефонной связи традиционно является необходимым элементом коммуникаций предприятия. Однако современные системы телефонии &ndash; это не просто соединение двух абонентов, а полноценный коммуникационный сервер, предоставляющий, кроме основных, целый ряд сервисных возможностей, обеспечивающий высокое качество и надежность услуг связи.</p><br>

<div class="rbutton"> <span class="button_forms" id="intbuilding">Заказать систему</span> </div>

 <center><img src="/images/ei_automation_ib_phone.png" title="Телефонные сети от компании Эlevel Инженер" alt="Телефонные сети сети от компании Эlevel Инженер" vspace="5" class="sol_bp" /></center>
<br />
 
<p>Специалисты нашей компании возьмут  на себя проектирование и монтаж интегрированной телефонной сети Вашего предприятия с учетом особенностей зданий и помещений, задания по расположению точек подключения рабочих мест и прочих параметров.</p><br>
 
<p>Телефонные сети являются неотъемлемой частью комплекса систем информационного обеспечения наряду со следующими системами:</p>
