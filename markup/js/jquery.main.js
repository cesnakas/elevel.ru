...
function initPopups() {
    ...
    $('.popup-holder-over .open').click(function(e){
        e.preventDefault();
    });
...
// Плавно меняем центр карты на координаты метки.
   ...
   if(elementsCounts["map-spb"]){
    ...
    shopMaps["map-rostov"] = myMapRostov;
    ...
    shopMaps["map-novosib"] = myMapNovosib;
    ...
    shopMaps["map-samara"] = myMapSamara;
    ...
    shopMaps["map-bryansk"] = myMapBryansk;
    ...
    shopMaps["map-chelyabinsk"] = myMapСhelyabinsk;
    ...
    shopMaps["map-partners-msc"] = myPartMapMsc;
    ...
    shopMaps["map-partners-spb"] = myPartMapSpb;
    ...
    shopMaps["map-partners-ekb"] = myPartMapEkb;
