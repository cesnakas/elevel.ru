...
$(document).ready(function() {
	...
	$('input[name="form_text_472"]').keypress(function (e){
	...
	$('form[name="print_catalog_Deluxe_request"]').attr('id','back_call');
	
	$('#suber').click(function() {
	_gaq.push(['_trackEvent', 'sent_print_cat', 'action', 'opt_label', 1]); yaCounter1485305.reachGoal('sent_print_cat');
		NAMEUSER = $('input[name="form_text_470"]').val();
		COMPANY = $('input[name="form_text_471"]').val();
		PHONEUSER = $('input[name="form_text_472"]').val();
		EMAIL = $('input[name="form_text_473"]').val();
...
<h6 style="*top: -51px !important">Заказать печатный каталог<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
<div id="simul_form">
<div class="info"></div>
