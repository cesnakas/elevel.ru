...
$(document).ready(function() {
	...
	$('#suber').click(function() {
		_gaq.push(['_trackEvent', 'sent_presentation', 'action', 'opt_label', 1]); yaCounter1485305.reachGoal('sent_presentation'); 
...
$(".w170").css('width','205px');
$('textarea').attr('class','h92');
$('.presentation').parent().parent().prev().children().css('padding-bottom','0px');
$("#form_dropdown_profile").attr('class','sel1');
$('input[name="web_form_submit"]').css('display','none');
});
</script>
<h6 style="*top: -51px !important;">Заказать презентацию<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close" /></h6>
<div id="simul_form">
<div class="info"></div>
