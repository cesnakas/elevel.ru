...
$(document).ready(function() {
    ...
    $('input[name="form_text_664"]').keypress(function (e){
    ...
    $('input[name="form_text_664"]').keyup(function (){
        var phone = $(this).val();
        
        $('input[name="form_text_664"]').not($(this)).val(phone);
    });
    
    $('input[name="form_email_665"]').keyup(function (){
        var email = $(this).val();
        $('input[name="form_email_665"]').not($(this)).val(email);
    });
    
    $('input[name="form_text_663"]').keyup(function (){
        var name = $(this).val();
        $('input[name="form_text_663"]').not($(this)).val(name);
    });
    
    $('textarea[name="form_textarea_666"]').keyup(function (){
        var comm = $(this).val();
        console.log(comm);
        $('textarea[name="form_textarea_666"]').not($(this)).val(comm);
    });
...
<h6>Заказать электролабораторию<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
