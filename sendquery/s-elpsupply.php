...
$(document).ready(function() {
    ...
    $('input[name="form_text_672"]').keyup(function (){
        var phone = $(this).val();
        
        $('input[name="form_text_672"]').not($(this)).val(phone);
    });
    
    $('input[name="form_email_673"]').keyup(function (){
        var email = $(this).val();
        $('input[name="form_email_673"]').not($(this)).val(email);
    });
    
    $('input[name="form_text_671"]').keyup(function (){
        var name = $(this).val();
        $('input[name="form_text_671"]').not($(this)).val(name);
    });
    
    $('textarea[name="form_textarea_674"]').keyup(function (){
        var comm = $(this).val();
        console.log(comm);
        $('textarea[name="form_textarea_674"]').not($(this)).val(comm);
    });
    ...
    $('#suber').click(function() {
        ...
        MESSAGES=$('textarea[name="form_textarea_674"]').val();
        textError='';
        error = 0;
