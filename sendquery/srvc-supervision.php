...
$(document).ready(function() {
    ...
    $('input[name="form_text_659"]').keypress(function (e){
    ...
    $('input[name="form_text_659"]').keyup(function (){
        var phone = $(this).val();
        
        $('input[name="form_text_659"]').not($(this)).val(phone);
    });
    
    $('input[name="form_email_662"]').keyup(function (){
        var email = $(this).val();
        $('input[name="form_email_662"]').not($(this)).val(email);
    });
    
    $('input[name="form_text_658"]').keyup(function (){
        var name = $(this).val();
        $('input[name="form_text_658"]').not($(this)).val(name);
    });
    
    $('textarea[name="form_textarea_661"]').keyup(function (){
        var comm = $(this).val();
        console.log(comm);
        $('textarea[name="form_textarea_661"]').not($(this)).val(comm);
    });
    ...
    $('#suber').click(function() {
        ...
        NAMEUSER = $('input[name="form_text_658"]').val();
        EMAIL = $('input[name="form_email_662"]').val();
        PHONEUSER = $('input[name="form_text_659"]').val();
        MESSAGES=$('textarea[name="form_textarea_661"]').val();
        textError='';
        error = 0;
...
<h6>Заказать Технический и авторский надзор<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
