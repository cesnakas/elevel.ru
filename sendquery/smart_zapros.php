...
$(document).ready(function() {
	$(".table10").append('<tr><td colspan="4" style="padding-top:10px;"><p class="txt8"><span>*</span> Обязательные для заполнения поля.</p></td></tr><tr><td colspan="2" style="padding-top:10px;"> <span id="call_close2" style="padding-left: 100px; padding-right: 20px;"><img src="/i/btn140f.gif"  /></span><span id="suber2"><img src="/i/btn140g.gif"  /></span></td> </tr>');
	...
	$('#suber2').click(function() {
		...
		if(PHONEUSER2==''){textError+='Введите номер телефона<br>';error = 1;};
...
*/?>
<h6>Быстрый запрос<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
<div id="simul_form">
<div class="info"></div>
