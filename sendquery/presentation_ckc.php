...
<h6 style="*top: -51px !important">Отправить запрос<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
<div id="simul_form">
<div class="info"></div>
...
$APPLICATION->SetTitle("Запросить индивидуальную презентацию для системного интегратора");
?>
