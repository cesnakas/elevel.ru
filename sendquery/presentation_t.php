...
$(document).ready(function() {
	...
	$('input[name="form_text_165"]').keypress(function (e){
	...
	$('form[name="SIMPLE_FORM_13"]').attr('id','back_call');

	$('#suber').click(function() {
		_gaq.push(['_trackEvent', 'sent_simple_t', 'action', 'opt_label', 1]); yaCounter1485305.reachGoal('sent_simple_t');
		NAMEUSER = $('input[name="form_text_164"]').val();
		PHONEUSER = $('input[name="form_text_165"]').val();
		EMAIL = $('input[name="form_email_166"]').val();
...
$APPLICATION->SetTitle("Запросить индивидуальную презентацию для торгового партнёра");
?>
