...
$(document).ready(function() {
	...
	$('input[name="form_text_48"]').keypress(function (e){
		if( e.which!=8 && e.which!=13 && e.which!=0 && (e.which<48 || e.which>57)){
            ...
            $('#simul_form').css('height','275px');
            setTimeout( function () {$('#simul_form').css('height','240px');}, 3000); 
			return false;
		}
	});
    ...
    $('input[name="form_text_48"]').keyup(function (){
        var phone = $(this).val();
        
        $('input[name="form_text_48"]').not($(this)).val(phone);
    });
    
    $('input[name="form_email_50"]').keyup(function (){
        var email = $(this).val();
        $('input[name="form_email_50"]').not($(this)).val(email);
    });
    
    $('input[name="form_text_46"]').keyup(function (){
        var name = $(this).val();
        $('input[name="form_text_46"]').not($(this)).val(name);
    });
    
    $('textarea[name="form_textarea_676"]').keyup(function (){
        var comm = $(this).val();
        console.log(comm);
        $('textarea[name="form_textarea_676"]').not($(this)).val(comm);
    });
	
	$('form[name="SIMPLE_FORM_4"]').attr('id','back_call');

	$('#suber').click(function() {
		_gaq.push(['_trackEvent', 'sent_sneg', 'action', 'opt_label', 1]); yaCounter1485305.reachGoal('sent_sneg');
...
<h6>Системы снеготаяния<img src="/i/pix.gif" alt="" width="18" height="19" id="callback_close"/></h6>
<div style="height:240px; /*overflow-y:scroll;*/ margin:-17px 16px 17px 0; position:relative; z-index:10; padding-top: 10px;" id="simul_form">
<div class="info"></div>
