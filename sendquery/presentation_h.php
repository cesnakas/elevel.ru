...
$(document).ready(function() {
	...
	$('form[name="SIMPLE_FORM_15"]').attr('id','back_call');
	
	$('#suber').click(function() {
		_gaq.push(['_trackEvent', 'sent_simple_h', 'action', 'opt_label', 1]); yaCounter1485305.reachGoal('sent_simple_h');
		NAMEUSER = $('input[name="form_text_327"]').val();
		//COMPANY = $('input[name="form_text_471"]').val();
		PHONEUSER = $('input[name="form_text_334"]').val();
		EMAIL = $('input[name="form_email_333"]').val();
...
$APPLICATION->SetTitle("Запросить индивидуальную презентацию для щитовика");
?>
