...
$APPLICATION->SetPageProperty("tags", "ландшафтное освещение, освещение в ландшафтном дизайне, освещение ландшафтов, освещение приусадебного участка, садово-парковое освещение, освещение сада, освещение усадеб, освещение в усадьбах, освещение загородного участка, проектирование ландшафтного освещения");
$APPLICATION->SetPageProperty("keywords", "ландшафтное освещение, освещение в ландшафтном дизайне, ландшафтное светодиодное освещение, проект ландшафтного освещения участка");
$APPLICATION->SetPageProperty("description", "Компания Эlevel предлагает реализацию проектов ландшафтного освещения для коммерческих территорий, садово-парковых зон, приусадебных участков.");
$APPLICATION->SetTitle("Ландшафтное освещение | Эlevel");
?> 
<h1>Ландшафтное освещение</h1>
 <?if($_REQUEST["print"] !== "Y"){?>
...
<p>Ландшафтное освещение  - это особая световая технология, которая способна подчеркнуть все достоинства освещаемой территории. Более того, с данной технологией Вы можете создавать такие достоинства сами и в тех местах, где Вы этого пожелаете.</p>
 
<br />
 
<p>Освещение в ландшафтном дизайне &ndash; сфера, в которой наша компания имеет  немалый успешный опыт по созданию и реализации проектов.</p>
 <center><img src="/images/ei_landscape_lighting.png" alt="Светотехнический проект ландшафтного освещения от компании Эlevel Инженер" title="Светотехнический проект ландшафтного освещения от компании Эlevel Инженер" class="sol_bp"  /> </center> 
<br />
 
<p>Мы предлагаем:</p>
 
<ul class="list_sol"> 
  <li>устройство ландшафтного света для коммерческих территорий, садово-парковых зон, освещение приусадебных участков;</li>
 
  <li>декоративная подсветка деревьев, водоёмов и пр.</li>
 
  <li>интересные световые решения для ландшафтного дизайна без ущерба функциональности и воздействия на зрение;</li>
 
  <li>использование энергосберегающих технологий и светильников.</li>
 </ul>
