...
$APPLICATION->SetPageProperty("tags", "система вентиляции, система вентиляции умного дома, система вентиляции и кондиционирования, вентиляция и кондиционирование воздуха, управление вентиляцией, система управления вентиляцией, автоматизированная систему управления вентиляцией, автоматизация вентиляции, автоматизация систем вентиляции, автоматизация вентиляции и кондиционирования, автоматизация систем кондиционирования, автоматизация кондиционирования, система вентиляции и кондиционирования, управление вентиляцией и кондиционированием, вентиляция и кондиционирование в умном доме, управление температурой или влажностью, микроклимат помещений, микроклимат комнат, термостат, датчики температуры, датчики влажности");
$APPLICATION->SetPageProperty("keywords", "система вентиляции, система вентиляции умного дома, система вентиляции и кондиционирования, вентиляция и кондиционирование воздуха, управление вентиляцией, система управления вентиляцией, автоматизированная систему управления вентиляцией, автоматизация вентиляции, автоматизация систем вентиляции, автоматизация вентиляции и кондиционирования, автоматизация систем кондиционирования, автоматизация кондиционирования, система вентиляции и кондиционирования, управление вентиляцией и кондиционированием, вентиляция и кондиционирование в умном доме, управление температурой или влажностью, микроклимат помещений, микроклимат комнат, термостат, датчики температуры, датчики влажности");
$APPLICATION->SetTitle("Система вентиляции и кондиционирования воздуха ");
?> 
<h1>Система вентиляции и кондиционирования воздуха</h1>
...
<p>Вентиляция и кондиционирование воздуха - одна из задач комплекса систем жизнеобеспечения, без которых невозможно функционирование любого современного здания. Именно благодаря автоматизации вентиляции и кондиционирования стало возможным создание и поддержка благоприятного микроклимата на объекте любого масштаба.</p>

<br />
 <center><img src="/images/ei_automation_smarthouse_va.png" title="Система вентиляции и кондиционирования воздуха от компании Эlevel Инженер" alt="Система вентиляции и кондиционирования воздуха от компании Эlevel Инженер" vspace="5" class="sol_bp"  /></center> 
<br />
 
<p>Мы предлагаем проектирование и установку автоматизированной системы для дома и промышленного использования. С учетом особенностей и потребностей объекта мы разработаем оптимальную схему циркуляции свежего воздуха и  кондиционирования, позволяющую поддерживать необходимые Вам влажность и температуру круглосуточно.</p>
...
<p>С проектированием данной системы неразрывно связано и проектирование других инженерных систем &mdash; водоснабжения, электроснабжения, отопления и пр. Только согласованная и бесперебойная работа всех перечисленных сетей обеспечит выполнение задач, предусмотренных проектом.</p>
