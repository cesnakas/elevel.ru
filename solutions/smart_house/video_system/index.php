...
<p>Одно из приоритетных направлений в области безопасности &ndash; применение систем видеонаблюдения (система охранного телевидения), необходимое для постоянного контроля ситуации на объекте.</p>
...
<p>Благодаря системе видеонаблюдения предоставляется возможность оперативно реагировать на события, не вступая в контакт с нарушителями. Кроме того, при использовании на коммерческом объекте система дисциплинирует сотрудников и предотвращает хищения имущества.</p>
...
<br>
<p>Система видеонаблюдения является неотъемлемой частью комплекса технических средств безопасности наряду со следующими системами:
	<ul class="list_sol">
<li><a href='/solutions/automation/intellectual_building/access_control_system/'>система контроля доступа;</a></li>
<li><a href='/solutions/automation/smart_house/alarm_system/'>система пожарной сигнализации;</a></li>
<li><a href='/solutions/automation/smart_house/alarm_system/'>система охранной сигнализации;</a></li>
<li><a href='/solutions/automation/intellectual_building/lighting_protection/'>система молниезащиты.</a></li>
	</ul>
</p>
<br>
