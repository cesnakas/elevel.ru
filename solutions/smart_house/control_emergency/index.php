...
<p>Безусловно, вероятность возникновения аварийных ситуаций относится к проблемам, вызывающим постоянное беспокойство. Однако с помощью современных систем диспетчеризации можно раз и навсегда избавиться от тревог и держать ситуацию под неусыпным контролем. </p>

<br />
 <center><img src="/images/ei_automation_smarthouse_ask.png" title="Автоматизированная система контроля и учета энергоресурсов (АСКУЭ) от компании Эlevel Инженер" alt="Автоматизированная система контроля и учета энергоресурсов (АСКУЭ) от компании Эlevel Инженер" vspace="5" class="sol_bp"  /></center> 
<br />
 
<p>Для централизованного контроля мы предлагаем разработку автоматизированной системы контроля и управления эксплуатацией инженерных систем (<strong>АСКУЭ</strong>), позволяющую реализовать множество задач, в том числе в области контроля и предотвращения аварийных ситуаций:</p>
 
<ul class="list_sol"> 
  <li>контроль работы инженерных систем и подконтрольного оборудования;</li>
 
  <li>оперативное оповещение об отклонении параметров от заданных значений, отказе технологического оборудования (звуковое оповещение, сообщение через Интернет или sms; оповещение аварийных служб);</li>
 
  <li>включение соответствующих защитных устройств (прекращение подачи воды, газа, электричества и пр.);</li>
 
  <li>регистрация и сохранение информации о контролируемых параметрах, аварийных ситуациях;</li>
 </ul>
 
<div class="" style="float: right; width: 370px; margin-left: 18px;">  
 
<p>Также можно использовать децентрализованные системы контроля аварийных ситуаций, объединяющие отдельные датчики и контроллеры, решающие отдельные задачи:</p>
 
<ul class="list_sol"> 
  <li>система защиты от протечек,</li>
 
  <li>тепловые и дымовые датчики и пожарные системы в целом</li>
 
  <li>система контроля утечки газа и пр.</li>
 </ul>
