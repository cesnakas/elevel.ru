...
$APPLICATION->SetPageProperty("title", "ЩР – щиты распределительные, ЩУР – щиты учетно-распределительные");
$APPLICATION->SetTitle("ЩР – щиты распределительные, ЩУР – щиты учетно-распределительные");
?> 
		...
		<section class="switch-block">
			...
			<?$APPLICATION->IncludeComponent(
				  ...
				  array(
					...
					"PAGE_TITLE" => "Щиты учета распределения ЩУР",
