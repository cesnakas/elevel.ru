...
$APPLICATION->SetPageProperty("title", "Автоматические вводы резерва АВР");
$APPLICATION->SetTitle("Автоматический ввод резерва (АВР)");
?> 
...
<section class="section-special-offer">
	<h2>Получить коммерческое предложение на комплектующие МКУ</h2>
	<?$APPLICATION->IncludeComponent(
		"magnitmedia:form.result.new", 
		"form2", 
		array(
			...
			"PAGE_TITLE" => "Автоматический ввод резерва АВР",
			"PAGE_URL" => "",
			"VARIABLE_ALIASES" => array(
				"WEB_FORM_ID" => "WEB_FORM_ID",
				"RESULT_ID" => "RESULT_ID",
