...
$APPLICATION->SetTitle("Вводное распределительное устройство ВРУ");
?> 
...
<div class="top-service-block clearfix">
	...
	<div class="right-block">
		...
		<section class="switch-block">
			<h3>Получить коммерческое предложение на ВРУ для вашего проекта</h3>
			<?$APPLICATION->IncludeComponent(
				  ...
				  array(
					...
					"PAGE_TITLE" => "Вводное распределительное устройство ВРУД",
...
<section class="section-special-offer">
	...
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"COMPONENT_TEMPLATE" => ".default",
			"MANAGER_EMAIL" => "nku_msk@elevel.ru",
			"FORM_TITLE" => "Вводное распределительное устройство ВРУ",
