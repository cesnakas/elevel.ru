                    ...
                    <div class="img_box">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/includes/partners/trade/shop/leader.php" 
							)
						);?>
                    </div>
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"AREA_FILE_SUFFIX" => "",
							"EDIT_TEMPLATE" => "",
							"PATH" => "/includes/partners/trade/shop/name_post.php" 
						)
					);?>
                </div>
            </div>
                ...
                <div class="from_me_block">
                    ...
                    <?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"AREA_FILE_SUFFIX" => "",
							"EDIT_TEMPLATE" => "",
							"PATH" => "/includes/partners/trade/shop/from_me.php" 
						)
					);?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="header_fz24">Наши торговые партнёры успешно удовлетворяют своих покупателей – всем<br> необходимым для этого мы их обеспечили.</h4>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="about_us_block">
                    <div class="about_us_img">
                        <img src="/includes/nano/icons/b_about_ico_9.png" alt="">
                    </div>
                    <div class="about_us_txt">
                        <h5>Мгновенное выставление счета </h5>
                        <span>с ценами и наличием. Как мы это делаем? Расскажем при встрече</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="about_us_block">
                    ...
                    <div class="about_us_txt">
                        ...
                        <span>(скидки и бонусы за объём, продвижение новых продуктов, работу по широкой линейке брендов)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="about_us_block">
                    ...
                    <div class="about_us_txt">
                        <h5>Помощь в создании контента</h5>
                        <span>для Вашего интернет-магазина (фотографии и описания товара)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="about_us_block">
                    ...
                    <div class="about_us_txt">
                        <h5>Обучение Вашего торгового персонала </h5>
                        <span>(семинары по основам электротехники и ассортименту на базе нашего офиса, а также в центрах обучения производителей ABB, Legrand, Schneider Electric)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-sm-12">
                <div class="about_us_block">
                    ...
                    <div class="about_us_txt">
                        <h5>Право возврата заказа</h5>
                        <span>в течение 2-х недель (по договоренности) </span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="column_block">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/includes/partners/trade/shop/advantages_left.php" 
							)
						);?>
                    ...
                    <div class="column_block right_align">
						<?$APPLICATION->IncludeComponent(
							...
							Array(
								...
								"AREA_FILE_SUFFIX" => "",
								"EDIT_TEMPLATE" => "",
								"PATH" => "/includes/partners/trade/shop/advantages_right.php" 
							)
						);?>
