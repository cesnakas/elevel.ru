...
$APPLICATION->SetPageProperty("title", "Интернет-магазинам");
...
$APPLICATION->SetPageProperty("description", "Сотрудничество с Эlevel для Интернет-магазинов");
...
<div class="heading-partners clearfix">
	<ul class="trade-nav">
		...
		<li><a class="diy" href="/partners/trade/diy/">DIY сетям</a></li>
		<li><h1>Интернет-магазинам</h1></li>
	</ul>
...
<div class="top-service-block clearfix">
	...
	array(
		...
		"FORM_TITLE" => "Форма обратной связи Интернет-магазинам",
		"PAGE_TITLE" => "Предложение сотрудничества Интернет-магазинам",
		"PAGE_URL" => "",
...
<?$APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "otk_msk@elevel.ru",	"FORM_TITLE" => "Форма обратной связи с руководителем",	"PAGE_TITLE" => ""), $component);?>
...
?>
	<section>
		<h2>Акции для торговых партнеров</h2>
		<?$APPLICATION->IncludeComponent(
		"bitrix:news.list", 
		"actions", 
		array(
