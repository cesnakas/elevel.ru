...
$APPLICATION->SetPageProperty("title", "Розничным магазинам");
...
$APPLICATION->SetPageProperty("description", "Торговым партнерам Розничным магазинам");
$APPLICATION->SetTitle("Розничным магазинам");
?>
<div class="heading-partners clearfix">
	<ul class="trade-nav">
		<li><h1>Розничным магазинам</h1></li>
...
<div class="top-service-block clearfix">
	...
	array(
		...
		"FORM_TITLE" => "Форма обратной связи Розничным магазинам",
		"PAGE_URL" => "",
		"PAGE_TITLE" => "",
...
<?$APPLICATION->IncludeComponent('magnitmedia:geoip.manager_content', '', array("MANAGER_EMAIL" => "6kv_msk@elevel.ru"), $component);?>
