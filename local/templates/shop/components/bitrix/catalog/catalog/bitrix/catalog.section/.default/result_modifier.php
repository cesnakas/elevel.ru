...
foreach ($arResult['ITEMS'] as $key => &$arItem)
{
	...
	{
		$arPhotoSmall = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"], array('width'=>113, 'height'=>105), BX_RESIZE_IMAGE_PROPORTIONAL, Array("name" => "sharpen", "precision" => 0));
		$arItem["PICTURE"] = $arPhotoSmall["src"];
	}
	elseif ($arItem["DETAIL_PICTURE"]["SRC"])
	{
		$arPhotoSmall = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array('width'=>113, 'height'=>105), BX_RESIZE_IMAGE_PROPORTIONAL, Array("name" => "sharpen", "precision" => 0));
		$arItem["PICTURE"] = $arPhotoSmall["src"];
	}
}
