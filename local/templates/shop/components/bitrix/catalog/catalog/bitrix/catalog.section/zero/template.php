...
<form class="form-catalog" action="#">
	<fieldset>
		<div class="columns-container">
			<aside class="aside-left col col-3 popup-holder"></aside>
							...
							<li id="<? echo $strMainID; ?>">
								...
								<div class="text-holder">
									...
									<div class="table-cell">
										 <input readonly class="spinner" id="<?=$arItem["ID"]?>" data-multiplicity="<?=$arItem['MEASURE_RATIO']?>" type="text" value="<?=$arItem['MEASURE_RATIO']?>" />
									</div>
									<div class="table-cell">
										 <span class="sum">
									...
									<div class="table-cell button-block">
										<button class="button add2basket" id="add<?=$arItem["ID"]?>" type="button"><span class="cssload-container"><span class="cssload-loading"><i></i><i></i><i></i><i></i></span></span><span class="button-title">В корзину</span></button>
										<?if ($arItem["STORES_COUNT"] > 0):?>
