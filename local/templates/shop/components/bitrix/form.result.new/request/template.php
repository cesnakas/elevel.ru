...
<div id="request" class="lightbox">
    ...
    <fieldset>
            ...
            <div class="form-column">
                ...
                <div class="input-holder">
                    <input <? if ($arResult["QUESTIONS"]["phone"]["REQUIRED"] == "Y"): ?>required<? endif; ?>
                           ...
                           placeholder="Телефон" id="request_phone" type="text" <?= $arResult["USER"]["PHONE"] ?> />
                </div>
        ...
        <div class="button-center">
            ...
            <button class="button" type="submit" name="web_form_submit" id="request_submit">Отправить запрос</button>
        </div>
