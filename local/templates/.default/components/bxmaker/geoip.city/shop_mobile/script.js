...
if (window.frameCacheVars !== undefined) {
    BX.addCustomEvent("onFrameDataReceived", function (json) {
        window.BXmakerGeoIPCityMobile.init($('.popup-holder2'));
    });
} else {
    BX.ready(function () {
        window.BXmakerGeoIPCityMobile.init($('.popup-holder2'));
...
if (!!window.BXmakerGeoIPCityMobile === false) {

    (function () {


        var BXmakerGeoIPCityConstructorMobile = function () {
            var that = this;
            that.params = {};
            that.box = null;
            that.popup = null;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.init = function (box) {
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.log = function () {
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.logError = function () {
            if (window.BXmakerDebugGeoIP) {
                var args = Array.prototype.slice.call(arguments);
                args.unshift('bxmaker:geoip.city: ');
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.getBaseDomain = function () {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.intval = function (num) {
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.cookie = function (name, value, params) {
            var that = this;
            var d = new Date();
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.getJsonFromUrl = function (hashBased) {
            var query;
            if (hashBased) {
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.initEvent = function () {
            var that = this;
            ...
            that.popup.on("click", '.js-bxmaker__geoip__popup-option', function () {
                ...
                if (that.params.bUseYandexSearch) {
                    ...
                    that.selectLocation(item.attr('data-city_id'));
                    that.popupHide();
                }
                    ...
                    that.search(adres, function (r) {
                        ...
                        if (!!r.response) {
                            if (r.response.count <= 0) {
                                searchOptions.append($('<div class="popup-inner bxmaker__geoip__popup-search-option--empty">' + that.params.msgEmptyResult + '</div>'));
                            }
                            else {
								
								$(".popup2").append($('<div class="popup-inner"><ul id="new_cities_mobile"></ul></div>'));
								
                                for (var i = 0; i < r.response.count; i++) {
                                    var item = r.response.items[i];

                                    var itemName = (item.city + (!!item.district ? ', ' + item.district : '') + (!!item.region && item.region != item.city ? ', ' + item.region : '') + (!!item.country ? ', ' + item.country : ''));
                                    var itemHtml = '<li><a class="js-bxmaker__geoip__popup-option" href="" ';
                                    ...
                                    $("#new_cities_mobile").append($(itemHtml));
                                }
                            }
                        }
                        else if (!!r.error) {
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.popupHide = function () {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.popupShow = function () {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.search = function (query, success, error) {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.selectLocation = function (id, params) {
            var that = this;
            var params = params || {};
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.showCity = function () {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.getFullData = function() {
            var that = this;
        ...
        BXmakerGeoIPCityConstructorMobile.prototype.getLocation = function () {
            var that = this;
            return that.cookie('location') || 0;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getCity = function () {
            var that = this;
            return that.cookie('city') || false;
        };
        BXmakerGeoIPCityConstructorMobile.prototype.getCityId = function () {
            var that = this;
            return that.cookie('city_id') || 0;
        };
        BXmakerGeoIPCityConstructorMobile.prototype.getCountry = function () {
            var that = this;
            return that.cookie('country') || false;
        };
        BXmakerGeoIPCityConstructorMobile.prototype.getCountryId = function () {
            var that = this;
            return that.cookie('country_id') || 0;
        };
        BXmakerGeoIPCityConstructorMobile.prototype.getRegion = function () {
            var that = this;
            return that.cookie('region') || false;
        };
        BXmakerGeoIPCityConstructorMobile.prototype.getRegionId = function () {
            var that = this;
            return that.cookie('region_id') || 0;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getArea = function () {
            var that = this;
            return that.cookie('area') || false;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getZip = function () {
            var that = this;
            return that.cookie('zip') || '000000';
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getLng = function () {
            var that = this;
            return that.cookie('lng') || 0;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getLat = function () {
            var that = this;
            return that.cookie('lat') || 0;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getRange = function () {
            var that = this;
            return that.cookie('range') || false;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.getYandex = function () {
            var that = this;
            return that.cookie('yandex') || that.params.bUseYandexSearch;
        };

        BXmakerGeoIPCityConstructorMobile.prototype.checkRedirect = function(){
            var that = this;
        ...
        window.BXmakerGeoIPCityMobile = new BXmakerGeoIPCityConstructorMobile();
