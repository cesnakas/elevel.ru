	...
	<?if ($arResult["PAGE"] == "BRAND"):?>
			...
			<form class="form-catalog no-border" action="">
				<fieldset>
					<div class="columns-container catalog-page">
						...
						<div class="aside-left col col-3">
							...
							<nav class="popup" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
								<div class="popup-inner">
									<ul class="accordion">
										...
										<?if($trololo == "stop"):?>
											<li>
												<a title="Серии" class="accordion-open" href="">Серии</a>
												<div class="accordion-slide" style="display: none;">
													<ul>
														<?foreach ( $arResult['SERIES'] as $arSeries ):?>
															<li><a title="<?=$arSeries["NAME"]?>" href="<?=$arSeries["URL"]?>"><?=$arSeries["NAME"]?></a></li>
														<?endforeach?>
													</ul>
												</div>
											</li>
			 ...
			 </form> закрывается в bitrix:catalog.section -->
		...
		<div class="clearfix">
			...
			<div class="columns-container">
				<div class="col aside-left col-3">&nbsp;</div>
				<div class="content col col-9">
