...
$(function(){
    ...
    $(document).ready(function(){
		...
		$(document).on('click','#shops ul.tabset-cities a.select-city', function(e){
			change_city();
			init();
		});
        ...
        function change_city(){
			...
			var shopElements = $("#shops .select-city.active").data("elements");
			...
			$('#shops .list-title').each(function(){
