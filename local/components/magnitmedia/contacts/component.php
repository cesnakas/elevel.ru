...
// Идентификатор кеша
$cacheID = implode("_",array(($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter, $pagerParameters, 1));

// Директория кеша
$cachePath = '/cache_contacts/';
...
// {
	...
	if ( count($arResult["ITEMS"]) > 0){
		...
		$arSelect = array('ID', 'NAME' , 'SORT', "DEPTH_LEVEL", "IBLOCK_SECTION_ID", "UF_WHERE", "UF_CITY_LAT", "UF_CITY_LONG", "UF_DELEGATE_NAME", "UF_DELEGATE_EMAIL", "UF_DELEGATE_PHONE", "UF_EMAIL_FORM", "UF_CONTACTS_CITY_H3");
