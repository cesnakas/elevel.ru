...
<a class="<? if ($arParams['BUTTON_LINK'] != "Y"): ?>button <? endif; ?>lightbox-open form-open"
   <? if (SITE_SERVER_NAME == "elevel.ru"): ?>onclick="<?= ($arParams['BUTTON1_ONCLICK']) ? $arParams['BUTTON1_ONCLICK'] : "yaCounter1485305.reachGoal('svyazatsa'); return true;" ?>"<? endif; ?>
   href="#<?= $cntId ?>_lightbox"><?= ($arParams['BUTTON_TITLE']) ? $arParams['BUTTON_TITLE'] : GetMessage('BUTTON_TITLE') ?></a>

<div class="lightbox-holder">
    <div id="<?= $cntId ?>_lightbox" class="lightbox">
                            ...
                            foreach ($arQuestion['STRUCTURE'] as $arStructure):
                                ...
                                elseif ($arStructure['FIELD_TYPE'] == "textarea"):
                                    ...
                                    <div class="input-holder<?= ($arQuestion['REQUIRED'] == "Y") ? " required" : "" ?>">
                                        <textarea
                                                name="form_<?= $arStructure['FIELD_TYPE'] ?>_<?= $arStructure['ID'] ?>"
                                                placeholder="<?= $arQuestion['CAPTION'] ?>" cols="30"
                                                rows="10"></textarea>
                                    </div>
                                <?
                                endif;
