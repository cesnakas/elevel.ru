...
<form action="#" id="<?=$cntId?>_calc_form">
	...
	?>
	<div class="input-holder">
		<textarea data-field-name="form_<?=$arStructure['FIELD_TYPE']?>_<?=$arStructure['ID']?>" placeholder="<?=GetMessage('FORM8_MESSAGE')?>" class="calc_field" cols="30" rows="10"></textarea>
	</div>
	<?endif;?>
	...
	<div id="<?=$cntId?>_calculate" class="lightbox">
		<div id="<?=$cntId?>" class="feedback_form_container">
			...
			<div class="feedback_form_body">
				...
				{
				?>
				<h2><?=GetMessage('FORM8_POPUP_TITLE')?></h2>
