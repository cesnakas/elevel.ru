...
<a href="#<?= $cntId ?>_lightbox" class="visual web lightbox-open">
    <img src="<?= SITE_TEMPLATE_PATH ?>/images/web.jpg" alt=""/>
</a>

<div class="lightbox-holder">
    <div id="<?= $cntId ?>_lightbox" class="lightbox">
        <h3><?= ($arParams['POPUP_TITLE']) ? $arParams['POPUP_TITLE'] : GetMessage('POPUP_TITLE') ?></h3>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.isFormNote == "Y" || data.formresult == "Y") {
                        ...
                        $parent.parents(".lightbox").find("h3").hide();
