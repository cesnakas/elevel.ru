...
if(intval($arParams["PAGE_SIZE"]) <= 0)
	$arParams["PAGE_SIZE"] = 16;
...
if($this->startResultCache(false, ($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups())))
{
	...
	//ORDER BY
	$arSort = array(
		"UF_BRAND_PRODUCTS"=>"DESC",
	);
	//EXECUTE
	$rsSections = CIBlockSection::GetList($arSort, $arFilter, $arParams["COUNT_ELEMENTS"], $arSelect, array("nPageSize" => $arParams["PAGE_SIZE"]));
	$rsSections->SetUrlTemplates("", $arParams["SECTION_URL"]);
