...
<a class="phone-partners" title="<?=$arResult['PHONE']; ?>" href="tel:<?= $arResult['PHONE']; ?>"><?= $arResult['PHONE']; ?></a>
<?/*
	...
	if ($arParams['AJAX'] != 'Y') { ?>
        ...
        <span class="bxmaker__geoip__message bxmaker__geoip__message--default js-bxmaker__geoip__message preloader"
            ...
            <span class="bxmaker__geoip__message-value js-bxmaker__geoip__message-value v1"
				 ...
				 <a class="phone-partners" title="<?= $arResult['CURRENT']['MESSAGE']; ?>" href="tel:<?= $arResult['CURRENT']['MESSAGE']; ?>"><?= $arResult['CURRENT']['MESSAGE']; ?></a>
            ...
            <span class="bxmaker__geoip__message-value  js-bxmaker__geoip__message-value v2"
                 data-location="<?= $arParams['LOCATION']; ?>"
                 data-city="<?= $arParams['CITY']; ?>">
				 <a class="phone-partners" title="<?= $arResult['DEFAULT']['MESSAGE']; ?>" href="tel:<?= $arResult['DEFAULT']['MESSAGE']; ?>"><?= $arResult['DEFAULT']['MESSAGE']; ?></a>
            </span>
